        ...
        attachToLayer: function (layer, fromPos, isVertical) {
          if (!this._layer) {
            ...
            if (this._texName) {
              ...
              if (isVertical) {
                offsetY = fromPos.row < 2 ? 2 : -2;
              } else {
                offsetX = fromPos.col < 2 ? 2 : -2;
              }

              this._graphics.moveTo(offsetX, offsetY);
              this._graphics.lineTo(endPos.x - sttPos.x + offsetX, endPos.y - sttPos.y + offsetY);
